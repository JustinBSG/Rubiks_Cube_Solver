...
#define CENTRE_X		125
#define CENTRE_Y		159
#define HALF_OF_SQUARE	26
#define SAMPLE_SIZE		9

#define FACE_ONE_X		FACE_FIVE_X
#define FACE_ONE_Y		FACE_FIVE_Y - 2*HALF_OF_SQUARE - 15
#define FACE_TWO_X		FACE_FIVE_X - HALF_OF_SQUARE
#define FACE_TWO_Y		FACE_FIVE_Y - HALF_OF_SQUARE
#define FACE_THREE_X	FACE_FIVE_X - 2*HALF_OF_SQUARE - 15
#define FACE_THREE_Y	FACE_FIVE_Y
#define FACE_FOUR_X		FACE_FIVE_X + HALF_OF_SQUARE
#define FACE_FOUR_Y		FACE_FIVE_Y - HALF_OF_SQUARE
#define FACE_FIVE_X		CENTRE_X
#define FACE_FIVE_Y		CENTRE_Y
#define FACE_SIX_X		FACE_FIVE_X - HALF_OF_SQUARE
#define FACE_SIX_Y		FACE_FIVE_Y + HALF_OF_SQUARE
#define FACE_SEVEN_X	FACE_FIVE_X + 2*HALF_OF_SQUARE + 15
#define FACE_SEVEN_Y	FACE_FIVE_Y
#define FACE_EIGHT_X	FACE_FIVE_X + HALF_OF_SQUARE
#define FACE_EIGHT_Y	FACE_FIVE_Y + HALF_OF_SQUARE
#define FACE_NINE_X		FACE_FIVE_X
#define FACE_NINE_Y		FACE_FIVE_Y + 2*HALF_OF_SQUARE
...
void int2RGB(uint16_t, int*, int*, int*);
void printRGB(int, int, int, int, int); 	// for debug
void printColor(int, int, int, int, int); 	// for debug
void printColorRGB(int*, int*, int*); 		// for debug
void sumRGB(int, int*, int*, int*);
void averageRGB(int, int, int*);
void detect_sum(uint16_t, uint16_t, uint16_t, int*, int*, int*);	// call detect() to detect which square and sum the RGB
void writeColorIntoArray(int*, int*, int*, char*);					// write result into the char array
void ReadSquare(char*);
