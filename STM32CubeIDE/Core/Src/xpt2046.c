...
int detectTP(strType_XPT2046_Coordinate strDisplayCoordinate) {
	if (strDisplayCoordinate.y >= (FIRST_ROW_COL+10) && strDisplayCoordinate.y <= (SECOND_ROW_COL-10)) {
		if (strDisplayCoordinate.x >= (FIRST_ROW_COL+10) && strDisplayCoordinate.x <= (SECOND_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "0");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 0;
		}
		if (strDisplayCoordinate.x >= (THIRD_ROW_COL+10) && strDisplayCoordinate.x <= (FOURTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "1");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 1;
		}
		if (strDisplayCoordinate.x >= (FIFTH_ROW_COL+10) && strDisplayCoordinate.x <= (SIXTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "2");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 2;
		}
	...
	if (strDisplayCoordinate.y >= (THIRD_ROW_COL+10) && strDisplayCoordinate.y <= (FOURTH_ROW_COL-10)) {
		if (strDisplayCoordinate.x >= (FIRST_ROW_COL+10) && strDisplayCoordinate.x <= (SECOND_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "3");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 3;
		}
		if (strDisplayCoordinate.x >= (THIRD_ROW_COL+10) && strDisplayCoordinate.x <= (FOURTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "4");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 4;
		}
		if (strDisplayCoordinate.x >= (FIFTH_ROW_COL+10) && strDisplayCoordinate.x <= (SIXTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "5");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 5;
		}
	}
	if (strDisplayCoordinate.y >= (FIFTH_ROW_COL+10) && strDisplayCoordinate.y <= (SIXTH_ROW_COL-10)) {
		if (strDisplayCoordinate.x >= (FIRST_ROW_COL+10) && strDisplayCoordinate.x <= (SECOND_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "6");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 6;
		}
		if (strDisplayCoordinate.x >= (THIRD_ROW_COL+10) && strDisplayCoordinate.x <= (FOURTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "7");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 7;
		}
		if (strDisplayCoordinate.x >= (FIFTH_ROW_COL+10) && strDisplayCoordinate.x <= (SIXTH_ROW_COL-10)) {
			/*LCD_DrawString(180, 262, "8");
			HAL_Delay(500);
			LCD_Clear(180, 262, 8, 16, WHITE);*/
			return 8;
		}
	}
	/*LCD_DrawString(180, 262, "9");
	HAL_Delay(500);
	LCD_Clear(180, 262, 8, 16, WHITE);*/
	return 9; // nth input
}

void changeSquareColor(char* SquareOfOneFace, int num) {
	if (SquareOfOneFace[num] == 'W') {
		SquareOfOneFace[num] = 'O';
		return;
	}
	if (SquareOfOneFace[num] == 'O') {
		SquareOfOneFace[num] = 'G';
		return;
	}
	if (SquareOfOneFace[num] == 'G') {
		SquareOfOneFace[num] = 'Y';
		return;
	}
	if (SquareOfOneFace[num] == 'Y') {
		SquareOfOneFace[num] = 'B';
		return;
	}
	if (SquareOfOneFace[num] == 'B') {
...
void Check_touchkey(char* SquareOfOneFace)
{
	...
	{
		HAL_Delay(100);
		int num = detectTP(strDisplayCoordinate);
		/*LCD_Clear(0, 260, 50, 40, WHITE);
		char* strx[2], stry[2];
		sprintf(strx, "%d", strDisplayCoordinate.x);
		sprintf(stry, "%d", strDisplayCoordinate.y);
		LCD_DrawString(0, 260, strx);
		LCD_DrawString(0, 280, stry);
		HAL_Delay(100);*/
		if (num!=9) {
			changeSquareColor(SquareOfOneFace, num);
